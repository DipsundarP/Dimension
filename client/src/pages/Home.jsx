  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row g-2 justify-content-between align-items-center">
            <div className="col-md-6">
              <div className="d-inline-flex align-items-center text-center ms-md-2">
      ...
      <nav className="navbar navbar-expand-lg">
        <div className="container">
          <Link className="navbar-brand m-0 py-0" to="/">
            <img
              src="/assets/images/logo.svg"
              alt="Seven Dimension Travels Logo"
            />
            <h4>
              Seven Dimension Travels{" "}
              <small className="fw-normal mt-1">Meet The Horizon</small>
            </h4>
          </Link>
            ...
            <div className="offcanvas-header bg-white">
              <h5 className="offcanvas-title" id="offcanvasNavbarLabel">
                <img
                  ...
                  alt="Seven Dimension Travels Small Logo"
                />
              </h5>
              <button
                type="button"
        ...
        <Carousel fade controls={true} indicators={true} interval={1000}>
          ...
          <Carousel.Item>
            <section
              className="banner"
              style={{
                background: `linear-gradient(to right, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6), transparent), url('assets/images/banner/banner-1.jpg') no-repeat`,
              ...
              <div className="container">
                <div className="row align-items-center">
                  <div className="col-lg-7">
                    <h3 className="sub-title">Come With Us</h3>
                    <h1 className="mb-2">
                      Discover boundless adventures with our{" "}
                      <span>travel expertise.</span>
                    </h1>
                    <p className="fw-light text-light mb-4">
                      Experience unforgettable journeys with our curated travel
                      packages, expert guides, and seamless booking. Your
                      adventure awaits with us!
                    </p>
                    <div className="d-flex">
                      ...
                      <Link to="/package" className="btn2 ms-3">
                        View packages
                      </Link>
                    </div>
                  </div>
          ...
          <Carousel.Item>
            <section
              className="banner"
              style={{
                background: `linear-gradient(to right, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6), transparent), url('assets/images/banner/banner-2.jpg') no-repeat`,
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            >
                ...
                <div className="row align-items-center">
                  <div className="col-lg-7">
                    ...
                    <div className="d-flex">
                      ...
                      <a href="package.html" className="btn2 ms-3">
                        View packages
                      </a>
                    </div>
                  </div>
          ...
          <div className="row g-md-4 g-3">
            <div className="col-lg-4 col-6">
              <div className="inner-contain">
                <img
                  src="assets/images/trending-places/Shillong.jpg"
                  className="img-fluid"
                  alt="Shillong"
                />
            ...
            <div className="col-lg-4 col-6">
              <div className="inner-contain">
                <img
                  src="assets/images/trending-places/Cherrapunjee.jpg"
                  className="img-fluid"
                  alt="Cherrapunjee"
                />
            ...
            <div className="col-lg-4 col-6">
              <div className="inner-contain">
                <img
                  src="assets/images/trending-places/Kaziranga.jpg"
                  className="img-fluid"
                  alt="Kaziranga"
                />
            ...
            <div className="col-lg-4 col-6">
              <div className="inner-contain">
                <img
                  src="assets/images/trending-places/Tawang.jpg"
                  className="img-fluid"
                  alt="Tawang"
                />
            ...
            <div className="col-lg-4 col-6">
              <div className="inner-contain">
                <img
                  src="assets/images/trending-places/Sittong.jpg"
                  className="img-fluid"
                  alt="Sittong"
                />
            ...
            <div className="col-lg-4 col-6">
              <div className="inner-contain">
                <img
                  src="assets/images/trending-places/Pelling.jpg"
                  className="img-fluid"
                  alt="Pelling"
                />
      ...
      <section className="about py-5 bg-light">
        <div className="container">
          <div className="row g-4 align-items-center justify-content-between reverse">
            <div className="col-lg-6">
              <h3 className="sub-title mb-2 my-primary-color">About Us</h3>
              <h2 className="fw-semibold">
                WELCOME TO{" "}
                <span className="my-primary-color">7 DIMENSION TRAVELS</span>
              </h2>
              <p>
      ...
      {/* <!-- Why us section --> */}
      {/* <section className="py-5 why-us bg-light">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h3 class="sub-title my-primary-color">Why Us</h3>
                    <h2 class="title">Why 7 Dimension Is Best</h2>
                </div>
            </div>
