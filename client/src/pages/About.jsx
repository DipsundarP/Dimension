...
function About() {
  return (
    <>
        ...
        <div className="container">
          <div className="row g-4 align-items-center justify-content-between reverse">
            <div className="col-lg-6">
              ...
              <p>
                We provide options for changing the visual order of specific
                flex items with a handful of order utilities. You can make an
                item appear first or last, or reset to the original DOM order.
                For custom needs, additional CSS can be applied.
              </p>
            </div>
      ...
      {/* <!-- Objective section --> */}
      <section className="objective py-5">
        <div className="container">
          <div className="row g-4 align-items-center">
            ...
            <div className="col-lg-6 ps-lg-4">
              <h3 className="sub-title mb-2 my-primary-color">Objective</h3>
              <h2 className="fw-semibold">
                We provide the best{" "}
                <span className="my-primary-color">tour facilities.</span>
              </h2>
              <p>
                Aperiam sociosqu urna praesent, tristique, corrupti condimentum
                asperiores platea ipsum ad arcu. Nostrud. Esse? Aut nostrum,
                ornare quas provident laoreet nesciunt odio voluptates etiam,
                omnis. Change the visual order of specific flex items with a
                handful of order utilities. We only provide options for making
                an item first or last.
              </p>
              <div className="row g-4">
                <div className="col-sm-6">
                  <div className="inner-contain">
                    <img src="assets/images/safety.svg" alt="Safety Icon" />
                    <h3 className="mb-0">Safety First Always</h3>
                  </div>
                </div>
                <div className="col-sm-6">
                  <div className="inner-contain bg-dif">
                    <img src="assets/images/guide.svg" alt="Guide Icon" />
                    <h3 className="mb-0">Trusted Travel Guide</h3>
                  </div>
                </div>
                <div className="col-sm-6">
                  <div className="inner-contain bg-dif">
                    <img
                      ...
                      alt="Experience Icon"
                    />
                    <h3 className="mb-0">Expertise And Experience</h3>
                  </div>
                </div>
                <div className="col-sm-6">
                  <div className="inner-contain">
                    <img
                      src="assets/images/time-save.svg"
                      alt="Time Save Icon"
                    />
                    <h3 className="mb-0">Time and Stress Savings</h3>
                  </div>
                </div>
              </div>
